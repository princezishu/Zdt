...
const groupDealsAdminMiddlewares = [requireAuth, requirePermission('manage_promotions')];
...
router.get('/group-deals/admin/deals', ...groupDealsAdminMiddlewares, async (req, res, next) => {
  try {
...
router.get(
  '/group-deals/admin/deals/:dealCode/joins',
  ...groupDealsAdminMiddlewares,
  async (req, res, next) => {
  try {
...
router.post('/group-deals/admin/deals', ...groupDealsAdminMiddlewares, async (req, res, next) => {
...
router.patch(
  '/group-deals/admin/deals/:dealCode',
  ...groupDealsAdminMiddlewares,
  async (req, res, next) => {
  try {
    const dealCode = String(req.params.dealCode || '').trim().toUpperCase();
...
router.get('/group-deals/admin/requests', ...groupDealsAdminMiddlewares, async (req, res, next) => {
  try {
...
router.patch(
  '/group-deals/admin/requests/:requestId',
  ...groupDealsAdminMiddlewares,
  async (req, res, next) => {
  try {
...
router.post(
  '/group-deals/admin/requests/:requestId/approve-create-draft',
  ...groupDealsAdminMiddlewares,
  async (req, res, next) => {
  const client = await pool.connect();
  try {
